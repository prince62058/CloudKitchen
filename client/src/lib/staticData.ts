// Static data for deployment - Type compatible with MenuItem
...
export const staticMenuData: StaticMenuItem[] = [
  {
    "id": 1,
  ...
  },
  {
    ...
    "price": "150.00",
    "category": "indian",
    "image": "https://www.licious.in/blog/wp-content/uploads/2020/12/butter-chicken.jpg",
    "isAvailable": "true"
  },
  {
    "id": 3,
...
export const staticFeaturedItems = [
  staticMenuData.find(item => item.category === "indian")!,
  staticMenuData.find(item => item.category === "chinese")!,
  staticMenuData.find(item => item.category === "italian")!,
  staticMenuData.find(item => item.category === "south-indian")!,
  staticMenuData.find(item => item.category === "desserts")!
];